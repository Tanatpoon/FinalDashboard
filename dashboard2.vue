          ...
          <v-card-text>
            <v-row class="justify-center">
              <v-col cols="3" class="text-center">
                <v-avatar size="48" :color="isOn ? 'green' : 'grey'"></v-avatar>
                <div>ON</div>
              </v-col>
              <v-col cols="2" class="text-center">
                <v-avatar size="38" :color="numericValueState() === 1 || numericValueState() === 4 || numericValueState() === 5 ? 'red' : 'grey'"></v-avatar>
    </v-col>
    <v-col cols="2" class="text-center">
      <v-avatar size="38" :color="numericValueState() === 2 || numericValueState() === 4 || numericValueState() === 5 ? 'green' : 'grey'"></v-avatar>
    </v-col>
    <v-col cols="2" class="text-center">
      <v-avatar size="38" :color="numericValueState() === 3 || numericValueState() === 5 ? 'blue' : 'grey'"></v-avatar>
    </v-col>
    <v-col cols="3" class="text-center">
      <v-avatar size="48" :color="!isOn ? 'red' : 'grey'"></v-avatar>
                <div>OFF</div>
              </v-col>
            </v-row>
            <v-row class="justify-center">
      ...
      size="64"
      class="mx-auto"
      :color="temperatureStatus() === 'cold' || temperatureStatus() === 'quite cold' ? 'green' : 'grey'"
    >
      ...
      size="64"
      class="mx-auto"
      :color="humidityStatus() === 'hot' || humidityStatus() === 'quite hot' ? 'green' : 'grey'"
    >
